...
- User
	- Profile
	- Settings - Dark Theme, Categories to see, Notification preferences
- Dashboard
	- Info Card Widget
- Check In
	- Prompt
		...
		- AI Happiness
		- AI dependence
- Quizzes - Start with quiz template, option for randomised quizzes.
	- Prompt: image (for puzzle) or text
	- Types (Tags): Moral scenario (must have objective correct answer), mental maths, reading comprehension, word based math problem, puzzle.
		- Puzzle: pattern recognition, missing piece, mental math x + x = ?, how many folds, how many blank shapes.
	- Multiple choice answers.
	- Correct answer.
	- Categorise quiz
	- Puzzle based quizzes different tab, so only created by us.
	- Puzzle-based quizzes and templated quizzes.
# Old
## Problem Statement
...
### Primary Goals
1. Measure skill retention: Provide users with quantifiable insights into how their skills can change over time when they rely on AI. - Check Ins, Quizzes - can the two be compared?
...
Purpose of quiz and puzzles - does it combat AI degradation.
- App functionality
### Secondary Goals
