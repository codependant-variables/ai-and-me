...
- Agreed start and finish dates for "Sprint 3".
- What are we focusing our attention on in preparation for Week 9 submission.
- Seeing how we are feeling with this new plan.
...
| 94      | [Input Validation](https://github.com/codependant-variables/ai-and-me/issues/94)                 | Confirming whether we have caught abnormal data entered.                                               | 🏎️    | Yes       |
| 44      | [**Recent Activity**](https://github.com/codependant-variables/ai-and-me/issues/44)              | Give the dashboard immediate value show users what they last did                                       | 🏎️    | Yes       |
| **50**  | [**Clear and Readable Interface**](https://github.com/codependant-variables/ai-and-me/issues/50) | Typography, spacing, color standards set early *(Very similar if not the same as above)*               | 🏎️    | Yes       |
| **51**  | [**Navigation Menu Structure**](https://github.com/codependant-variables/ai-and-me/issues/51)    | The user needs to see a well structured nav menu for the app (kinda similar to #53)                    | 🏎️    | Yes       |
| 61      | [Layout Orientation](https://github.com/codependant-variables/ai-and-me/issues/61)               | Vertical/horizontal for device diversity.                                                              | 🏎️    | Yes       |
| 46      | [User Data Transparency](https://github.com/codependant-variables/ai-and-me/issues/46)           | Express to the user what specifically is what their data being used for.                               | 🏎️    | Yes       |
...
Assignments via [Sprint 3](https://github.com/orgs/codependant-variables/projects/3/views/8)
Thanks all
