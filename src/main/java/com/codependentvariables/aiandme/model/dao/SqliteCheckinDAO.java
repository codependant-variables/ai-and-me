...
public class SqliteCheckinDAO extends BaseSqliteDAO implements ICheckinDAO, IDatabaseEntity {
    private static final String schemaQuery = """
            CREATE TABLE IF NOT EXISTS checkins (
                ...
                ai_dependence DECIMAL NOT NULL,
                completed_at TIMESTAMP NOT NULL
            );
        """;

    private static final String seedDataQuery = """
            INSERT INTO checkins (user_id, ai_use, ai_happiness, ai_dependence, completed_at) VALUES (1, 5.0, 5.0, 5.0, '2026-04-14 17:28:00');
            INSERT INTO checkins (user_id, ai_use, ai_happiness, ai_dependence, completed_at) VALUES (2, 7.5, 2.5, 7.5, '2026-04-16 14:16:00');
        """;
    ...
    public void add(Checkin checkin) {
        final String query = "INSERT INTO checkins (user_id, ai_use, ai_happiness, ai_dependence, completed_at) VALUES (?, ?, ?, ?, ?)";
        ...
        int id = executeSqlWithGeneratedKeys(query,
                statement -> {
                    ...
                    statement.setTimestamp(5, checkin.getCompletedAt());
                });
