...
class QuizAttemptServiceTest {
    private final QuizAttemptService quizAttemptService = QuizAttemptService.createForTest(new MockQuizAttemptDAO(), new MockQuizAttemptQuestionDAO(), new MockQuizAttemptAnswerDAO(), new MockCategoryDAO());
    ...
    void saveAttemptCount() {
        ...
        int score = quizAttemptService.saveAttempt(quiz, 42, List.of(right1, right2, wrong3));
